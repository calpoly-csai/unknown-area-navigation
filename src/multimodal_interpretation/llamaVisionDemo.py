...
Model: meta-llama/Llama-3.2-11B-Vision-Instruct (HuggingFace Inference API)
Description: This file uses the Llama 3.2 Vision model via HuggingFace's
OpenAI-compatible API to convert .jpg images to textual descriptions
and traversability assessments in JSON format.

Uses the OpenAI-compatible chat completion format with the HuggingFace
router endpoint for vision-language models.

Usage:
    python llamaVisionDemo.py <path_to_image.jpg>
...
Reflection: Uses Meta's Llama 3.2 Vision model through HuggingFace's
inference router for high-quality image understanding.
'''
...
def _encode_image(image_path: str) -> str:
    """
    Load, resize if needed, and base64-encode the image for the HuggingFace Inference API.
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run Llama 3.2 Vision scene captioning on a JPG image."
    )
